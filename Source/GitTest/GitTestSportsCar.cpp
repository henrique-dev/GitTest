...
#include "GitTestSportsCar.h"
#include "GitTestSportsWheelFront.h"
#include "GitTestSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AGitTestSportsCar::AGitTestSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGitTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGitTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGitTestSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGitTestSportsWheelRear::StaticClass();
