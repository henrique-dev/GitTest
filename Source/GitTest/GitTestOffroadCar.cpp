...
#include "GitTestOffroadCar.h"
#include "GitTestOffroadWheelFront.h"
#include "GitTestOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AGitTestOffroadCar::AGitTestOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGitTestOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGitTestOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGitTestOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGitTestOffroadWheelRear::StaticClass();
